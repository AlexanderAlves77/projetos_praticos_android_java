# Android Java Engineering Portfolio

This repository contains a comprehensive collection of practical Android applications developed using Java. The projects were designed following a progressive learning methodology, covering fundamental to intermediate concepts in Android engineering, including user interface design, event-driven programming, data persistence, layout management, and real-world mobile application architecture.

The primary objective of this repository is to demonstrate engineering competency in native Android development using Java, emphasizing software design principles, maintainability, and practical application development.
...
├── AppMinhaIdeiaDB/            # SQLite database integration and persistence
├── AppModeloDrawable/          # Drawable resources and UI styling
├── AppSoma/                    # Arithmetic operations and event handling
├── AulaNivelamentoInterface/   # User interface fundamentals and layouts
├── FerramentaLayout/           # Layout experimentation and UI structuring
├── MeuWebSite/                 # WebView integration and web content rendering
├── MeusClientes/               # Full CRUD system with SQLite database
├── PrimeiroNivelamentoJava/    # Java fundamentals applied to Android
...
Active Development and Continuous Expansion

The repository evolves progressively with new projects, architectural improvements, and engineering refinements aligned with modern Android development standards.
